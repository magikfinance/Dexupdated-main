...
import { Currency, currencyEquals, ETHER, Percent, WETH } from 'dogenswapsdk'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WWDOGE')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'DOGE' : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'DOGE' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive DOGE')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
